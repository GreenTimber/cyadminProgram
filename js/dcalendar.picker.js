...
+function ($) {
	...
	var months = ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"],
		short_months = ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一", "十二"],
		daysofweek = ["周日", "周一", "周二", "周三", "周四", "周五", "周六", "周日"],
	...
	DCalendar.prototype = {
		...
		create : function(mode){
			...
			if(mode === "days") {
				...
				var sysDate = "今日: " + that.today.getFullYear()+ "-" + months[that.today.getMonth()] + "-" + that.today.getDate() + "," + daysofweek[that.today.getDay()]  ;
